...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        try:
            ...
            print(f"Qt GUI: Could not restore geometry: {
        ...
        self._lo_offset_callback = lambda i: Qt.QMetaObject.invokeMethod(
            self._lo_offset_combo_box, "setCurrentIndex", Qt.Q_ARG("int", self._lo_offset_options.index(i)))
        ...
        self.soapy_hackrf_source_0.set_frequency(0, (freq - lo_offset))
        self.soapy_hackrf_source_0.set_gain(0, 'AMP', False)
        self.soapy_hackrf_source_0.set_gain(0, 'LNA', min(max(16, 0.0), 40.0))
        self.soapy_hackrf_source_0.set_gain(
            0, 'VGA', min(max((gain*62), 0.0), 62.0))
        ...
        self._qtgui_const_sink_x_0_win = sip.wrapinstance(
            self.qtgui_const_sink_x_0.qwidget(), Qt.QWidget)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(
            gr.sizeof_char*1, '/tmp/wifi.pcap', True)
        ...
        self.msg_connect((self.ieee802_11_frame_equalizer_0,
                         'symbols'), (self.pdu_pdu_to_tagged_stream_0, 'pdus'))
        ...
        self.connect((self.soapy_hackrf_source_0, 0),
    ...
    def set_window_size(self, window_size):
        ...
        self.blocks_moving_average_xx_0.set_length_and_scale(
            (self.window_size + 16), 1)
        self.blocks_moving_average_xx_1.set_length_and_scale(
            self.window_size, 1)
    ...
    def set_lo_offset(self, lo_offset):
        ...
        self._lo_offset_callback(self.lo_offset)
        self.soapy_hackrf_source_0.set_frequency(
            0, (self.freq - self.lo_offset))
    ...
    def set_gain(self, gain):
        self.gain = gain
        self.soapy_hackrf_source_0.set_gain(
            0, 'VGA', min(max((self.gain*62), 0.0), 62.0))
