...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_hackrf_source_0.set_gain(0, 'VGA', min(max((gain*62), 0.0), 62.0))
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.blocks_delay_0_0, 0))
    ...
    def set_lo_offset(self, lo_offset):
        ...
        self._lo_offset_callback(self.lo_offset)
        self.soapy_hackrf_source_0.set_frequency(0, (self.freq - self.lo_offset))
    ...
    def set_gain(self, gain):
        self.gain = gain
        self.soapy_hackrf_source_0.set_gain(0, 'VGA', min(max((self.gain*62), 0.0), 62.0))
